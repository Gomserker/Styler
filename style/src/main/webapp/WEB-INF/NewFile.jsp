				...
				<c:forEach var="r" items="${daily}">
					<div class="col">
						<div class="card shadow-sm">
							...
							<a href="ReadDetailDailyC?no=${r.no}&mynick=${sessionScope.accountInfo.nickname}"> <img alt="게시글 이미지"
								...
								<div
									...
									<div class="btn-group">
										...
										<button type="button" class="btn btn-sm btn-outline-secondary"
											onclick="location.href='ReadDetailDailyC?no=${r.no}&mynick=${sessionScope.accountInfo.nickname}#comment'">댓글
											${NumOfComment}</button>
									</div>

									<small class="text-muted"><fmt:formatDate
											value="${r.date}" pattern="yyyy.MM.dd" /></small>
									<!-- 유저등록사진표시 -->
...
<script type="text/javascript" src="js/Review.js"></script>
	...
	<div class="container-fluid  row mt-5" id="head">
		<div class="d-flex align-items-center justify-content-center">
			 <a  href="DViewSearch" class="btn btn-outline-dark border-white rounded-pill">
            인기
          </a>
          <a  href="DDateSearch" class="btn btn-outline-dark border-white rounded-pill">
            최신
          </a>
          <a  href="DRandomSearch" class="btn btn-outline-dark border-white rounded-pill">
            랜덤
          </a>
          <a href="WriteDaily"
				class="btn btn-outline-red border-white rounded-pill">데일리 작성</a>
